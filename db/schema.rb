...
ActiveRecord::Schema.define(version: 2020_03_13_113712) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "computer_times", force: :cascade do |t|
    t.date "date"
    t.bigint "user_id"
    t.integer "minutes"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_computer_times_on_user_id"
  end
  ...
  add_foreign_key "computer_times", "users"
